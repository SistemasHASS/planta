export const CATELOGO_SCHEMA_V1 = {
    ...
    clientes : '++_pk,id,persona,&documentoFiscal,documento,tipoDocumento,nombre,esCliente',
    consignatarios : '++_pk,id,persona,&documentoFiscal,documento,tipoDocumento,nombre,esCliente',
    ...
    categorias: '++_pk,&id,codigoCultivo,codigo,nombre,descripcion,activo,fechaCreacion,bd',
    ...
    variedades: '++_pk,id,idcultivo,idmodulo,&codigo,idvariedad,variedad,procedencia,esEnsayo,bd',
