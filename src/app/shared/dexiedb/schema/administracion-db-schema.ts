...
export const ADMINISTRACION_SCHEMA_V1 = {
    ...
    correlativosDocumentos:'++_pk,&id,idempresa,ruc,idTipoDocumento,idTipoDocumentoNombre,serie,numero,eliminado,fechaCreacion,usuarioCre,usuarioMod,fechaModificacion,modo,bd'
}