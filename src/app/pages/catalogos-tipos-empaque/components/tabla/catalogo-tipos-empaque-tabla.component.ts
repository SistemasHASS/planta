...
@Component({
  selector: 'app-catalogo-tipos-empaque-tabla',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './catalogo-tipos-empaque-tabla.component.html',
  styleUrl: './catalogo-tipos-empaque-tabla.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CatalogoTiposEmpaqueTablaComponent {
