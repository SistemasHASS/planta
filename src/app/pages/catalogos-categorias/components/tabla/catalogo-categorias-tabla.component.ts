...
const COLUMNAS = [
  ...
  { campo: 'calibreNombre', label: 'Calibre', tipo: 'nvarchar' },
  { campo: 'descripcion', label: 'Descripción', tipo: 'nvarchar' },
...
@Component({
  selector: 'app-catalogo-categorias-tabla',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './catalogo-categorias-tabla.component.html',
  styleUrl: './catalogo-categorias-tabla.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CatalogoCategoriasTablaComponent {
